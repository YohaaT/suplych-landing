    ...
    <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#value" className="text-slate-600 hover:text-blue-900 transition-colors">Propuesta</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 py-4 px-4 space-y-4">
          ...
          <Link href="#value" className="block text-slate-600 py-2">Propuesta</Link>
